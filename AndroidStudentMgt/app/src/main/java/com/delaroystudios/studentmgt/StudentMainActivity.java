...
public class StudentMainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		getActionBar().hide();// to remove header bar
		...
		Show1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				showMessage("Student Management Application", "Developed by Muhammad Zohaib Arshad (github@zaibidev) (twitter@iamzaibi_)  (insta@iamzaibi)");
			}
		});
